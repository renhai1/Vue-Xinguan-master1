          ...
          <el-card>
            ...
            >
              ...
              <el-table-column prop="imageUrl" label="图片" align="center" width="150px" padding="0px">
                ...
                <!--              <img-->
                <!--                slot="error"-->
                <!--                :src="'http://localhost:8082/qlpqlp/'+scope.row.imageUrl"-->
                <!--                alt-->
                ...
                <template slot-scope="scope">
                  <el-popover placement="right"  trigger="hover">
                    <img :src="'http://127.0.0.1:8082/xinguanxiangmutupian/'+scope.row.imageUrl"  style="height: 200px;width: 200px"/>
                    <img  slot="reference" :src="'http://127.0.0.1:8082/xinguanxiangmutupian/'+scope.row.imageUrl" :alt="scope.row.imgUrl" style="height: 32px;width: 32px;cursor: pointer">
                  </el-popover>
                </template>
              </el-table-column>
              ...
              <span>
                ...
                <el-table height="700" :data="products" border>
                  ...
                  >
                    <template slot-scope="scope">
                      <img
                        :src="'http://127.0.0.1:8082/xinguanxiangmutupian/'+scope.row.imageUrl"
                        alt
