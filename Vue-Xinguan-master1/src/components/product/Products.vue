    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="6">
        ...
        <el-col :span="8">
          ...
          <el-button size="mini" icon="el-icon-refresh" @click="getproductList"
            >刷新</el-button
          >
        </el-col>
      </el-row>
      ...
      <template>
        ...
        >
          ...
          >
            ...
            <!--              <img-->
            <!--                slot="error"-->
            <!--                :src="'http://localhost:8082/xinguanxiangmutupian/'+scope.row.imageUrl"-->
            <!--                alt-->
...
export default {
  data() {
    return {
      // uploadApi:'http://localhost:8082/xinguanxiangmutupian/api/upload/image',
    ...
    async edit(id) {
      ...
      if (res.code == 200) {
        ...
        this.imgFilesList.push({
          url: "http://127.0.0.1:8082/xinguanxiangmutupian/" + item.imageUrl,
          name: item.name,
          id: item.id,
        });
      } else {
