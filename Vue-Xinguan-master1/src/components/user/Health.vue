    ...
    <el-card :style="{height:getHeight+'px'}">
      ...
      <h5 style="margin: 0px; padding: 0px">
        ...
        <div style="float: right; margin-bottom: 10px; vertical-align: center">
          <el-button @click="OpenHistory" size="mini" type="warning"
            >签到记录</el-button
          >
          <el-button
            ...
            >立即打卡</el-button
          >
          <el-button @click="reset" size="mini" v-if="!reported"
            >重置</el-button
          >
        </div>
      </h5>
      ...
      >
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item
                label="自2020年1月1日起,是否在湖北省停留过 (保存转车路过)"
                prop="passby"
              >
